  ...
  <div class="feildsection">
    ...
    <div class="container-fulid inner-feild-section mt-3 mt-2 pt-3 pb-3">
      ...
      <div class="inner-field ">
        <img src="images/extraculm.png" class="rounded field-inner-img" alt="Extra carriculam img">
        ...
        <div class="buttons">
          ...
          class="btn btn-outline-success btn-lg faizan"
            type="submit" value="Abascus"></form>
        </div>
        ...
        <div class="buttons">
         <form action="">
          <input  
          class="btn btn-outline-success btn-lg faizan"
            type="submit" value="Cuemath"></form>
        </div>

        <div class="buttons">
          <form action="addOlympiad">
          <input  
          class="btn btn-outline-success btn-lg faizan"
            type="submit" value="Olyampiad"></form>
        </div>

        <div class="buttons">
          <form action="addCoading">
          <input  
          class="btn btn-outline-success btn-lg faizan"
            type="submit" value="Coding"></form>
        </div>
   ...
   <div class="field-list">
    ...
    <ul class="course-list">
      ...
      <div class="lists">
        <li class="btn btn-outline-success btn-lg">
          <i class="fas fa-pencil-ruler"></i><a href=""> Extra Curriculum</a>
        </li>
      </div>
      <div class="lists">
        <li class="btn btn-outline-success btn-lg">
