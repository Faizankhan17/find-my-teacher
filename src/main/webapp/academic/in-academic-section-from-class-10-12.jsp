...
<body>
  ...
  <ul class="dropdown-menu" style="background:none;">
    ...
    <div class=" products">
        ...
        <div class="  col-md-3 col-lg-3 col-xs-12  pt-3 pb-3 ml-5 mt-2 mb-2 mr-3">
          
           <div class="sub"> <img src="images/All-subject-img1.jpg" style="margin-left:80px;"></div>
           
        <form action="addAll">
            <input type="submit" placeholder="All Subjects" value="All" class="info btn btn-secondary" style="width:150px; margin-left:50px;"></form>
        </div>

        <div class="  col-md-3 lg-3 col-xs-12  pt-3 pb-3 mt-2 mb-2">
            
           <div class="sub"> <img src="images/physic.jpg" style="margin-left:50px;"></div>
        <h4 class="info" style="text-align: center;"></h4>
       <form action="addAll">
            <input type="submit" placeholder="Physics" value="Physics" class="info btn btn-secondary" style="width:150px; margin-left:30px;"></form>
        </div>

        <div class="  col-md-3 lg-3 col-xs-12  pt-3 pb-3 mt-2 mb-2">
            
           <div class="sub"> <img src="images/chemistry.jpg" style="margin-left:50px;" ></div>
        <h4 class="info" style="text-align: center;"></h4>
         <form action="addChemistry">
            <input type="submit" placeholder="Chemistry" value="Chemistry" class="info btn btn-secondary" style="width:150px; margin-left:30px;"></form>
        </div>

        <div class="  col-md-3 lg-3 col-xs-12  pt-3 pb-3 mt-2 mb-2">
           
           <div class="sub"> <img src="images/10th-maths.jpg" style="margin-left:50px;"></div>
     
        <form action="addMaths">
            <input type="submit" placeholder="Mathamatics" value="Mathamatics" class="info btn btn-secondary" style="width:150px; margin-left:30px; "></form>
        </div>

        <div class="  col-md-3 lg-3 col-xs-12  pt-3 pb-3 mt-2 mb-2">
            
           <div class="sub"> <img src="images/bioo.jpg" style="margin-left:75px;"></div>
       
         <form action="addBiology">
            <input type="submit" placeholder="Biology" value="Biology" class="info btn btn-secondary" style="width:150px; margin-left:50px;"></form>
        </div>

        <div class="  col-md-3 lg-3 col-xs-12  pt-3 pb-3 mt-2 mb-2">
            
           <div class="sub"> <img src="images/geography.png" style="margin-left:50px;"></div>
       
         <form action="addGeography">
            <input type="submit" placeholder="Geography" value="Geography" class="info btn btn-secondary" style="width:150px; margin-left:30px;"></form>
        </div>
        <div class="  col-md-3 lg-3 col-xs-12  pt-3 pb-3 mt-2 mb-2">
           
           <div class="sub"> <img src="images/political-science.png" style="margin-left:50px;"></div>
       
         <form action="addPolitical">
            <input type="submit" placeholder="Political" value="Political" class="info btn btn-secondary" style="width:150px; margin-left:30px;"></form>
        </div>
        <div class="  col-md-3 lg-3 col-xs-12 pt-3 pb-3 mt-2 mb-2 ">
            
           <div class="sub"> <img src="images/computer.png" style="margin-left:50px;"></div>
      
         <form action="addComputer">
            <input type="submit" placeholder="Computer" value="Computer" class="info btn btn-secondary" style="width:150px; margin-left:30px;"></form>
        </div>

        <div class="  col-md-3 lg-3 col-xs-12 pt-3 pb-3 mt-2 mb-2 ">
            
           <div class="sub"> <img src="images/arts-group.png" style="margin-left:75px;" ></div>
      
         <form action="addArts">
            <input type="submit" placeholder="Arts" value="Arts" class="info btn btn-secondary" style="width:150px; margin-left:50px;"></form>
        </div>
        <div class="  col-md-3 lg-3 col-xs-12 pt-3 pb-3 mt-2 mb-2 ">
           
           <div class="sub"> <img src="images/economicss.jpg" style="margin-left:50px;"></div>
       
        <form action="addEconomics">
            <input type="submit" placeholder="Economics" value="Economics" class="info btn btn-secondary" style="width:150px; margin-left:30px;"></form>
        </div>

        <div class="  col-md-3 lg-3 col-xs-12 pt-3 pb-3 mt-2 mb-2 ">
           
           <div class="sub"> <img src="images/englishh.jpg" style="margin-left:50px;"></div>
      
         <form action="addEnglish">
            <input type="submit" placeholder="English" value="English" class="info btn btn-secondary" style="width:150px; margin-left:30px;"></form>
        </div>
        <div class="  col-md-3 lg-3 col-xs-12 pt-3 pb-3 mt-2 mb-2 ">
            
           <div class="sub"> <img src="images/buuniss.png" style="margin-left:50px;"></div>
     
        <form action="addBuisness">
            <input type="submit" placeholder="Business Studies" value="Business Studies" class="info btn btn-secondary" style="width:150px; margin-left:30px;"></form>
        </div>
