...
<body>
  ...
  <ul class="dropdown-menu" style="background:none;">
    ...
    <div class=" products">
        ...
        <form action="addAll">
            <input type="submit" placeholder="All Subjects" value="All Subjects" class="info btn btn-secondary" style="width:150px; margin-left:50px;"></form>
        </div>

        <div class="  col-md-4 lg-4 col-xs-12 ">
           
           <div class="sub"> <img src="images/englishh.jpg" style="margin-left:40px"></div>
        <form action="addEnglish">
            <input type="submit" placeholder="english" value="english" class="info btn btn-secondary" style="width:150px;"></form>
        </div>
