...
<body>
  ...
  <div class="feildsection">
    ...
    <div class="container-fulid inner-feild-section mt-3 mt-2 pt-3 pb-3">
      ...
      <div class="inner-field ">
        <img src="images/dance.png" class="rounded field-inner-img" alt="...">
        ...
        <div class="buttons">
         ...
         <form action="">
          ...
          class="btn btn-outline-success btn-lg faizan"
            type="submit" value="Bollywood Dance"></form>
        </div>

        <div class="buttons">
           <form action="addClassical">
          <input  
          class="btn btn-outline-success btn-lg faizan"
            type="submit" value="Classical"></form>
        </div>

        <div class="buttons">
         <form action="addWestern">
          <input  
          class="btn btn-outline-success btn-lg faizan"
            type="submit" value="Western Dance"></form>
        </div>
  ...
  <div class="field-list">
    ...
    <ul class="course-list">
      ...
      <div class="lists">
        <li class="btn btn-outline-success btn-lg">
          <i class="fas fa-american-sign-language-interpreting"></i> <a href=""> Dance</a>
        </li>
      </div>
      <div class="lists">
        <li class="btn btn-outline-success btn-lg">
