  ...
  <div class="feildsection">
    ...
    <div class="container-fulid inner-feild-section mt-3 mt-2 pt-3 pb-3">
      ...
      <div class="inner-field ">
        <img src="images/acadmic-image.png" class="rounded field-inner-img" alt="...">
        ...
        <div class="buttons">
          ...
          class="btn btn-outline-success btn-lg faizan"
            type="submit" value="Class-LKG"></form>
        </div>
        ...
        <div class="buttons">
         <form action="addukg">
          <input  
          class="btn btn-outline-success btn-lg faizan"
            type="submit" value="Class-UKG"></form>
        </div>

        <div class="buttons">
         <form action="addnursary">
          <input 
          class="btn btn-outline-success btn-lg faizan"
            type="submit" value="Class-Nursary"></form>
        </div>

        <div class="buttons">
         <form action="addclass1">
          <input 
          class="btn btn-outline-success btn-lg faizan"
            type="submit" value="Class-1"></form>
        </div>

        <div class="buttons">
         <form action="addclass2">
          <input 
          class="btn btn-outline-success btn-lg faizan"
            type="submit" value="Class-2"></form>
        </div>

        <div class="buttons">
         <form action="addclass3">
          <input 
          class="btn btn-outline-success btn-lg faizan"
            type="submit" value="Class-3"></form>
        </div>

        <div class="buttons">
         <form action="addclass4">
          <input 
          class="btn btn-outline-success btn-lg faizan"
            type="submit" value="Class-4"></form>
        </div>

        <div class="buttons">
         <form action="addclass5">
          <input  
          class="btn btn-outline-success btn-lg faizan"
            type="submit" value="Class-5"></form>
        </div>

        <div class="buttons">
         <form action="addclass6">
          <input 
          class="btn btn-outline-success btn-lg faizan"
            type="submit" value="Class-6"></form>
        </div>

        <div class="buttons">
         <form action="addclass7">
          <input  
          class="btn btn-outline-success btn-lg faizan" type="submit" value="Class-7"></form>
        </div>

        <div class="buttons">
         <form action="addclass8">
          <input  
          class="btn btn-outline-success btn-lg faizan" type="submit" value="Class-8"></form>
        </div>

        <div class="buttons">
         <form action="addclassaddclass9">
          <input  
          class="btn btn-outline-success btn-lg faizan" type="submit" value="Class-9"></form>
        </div>

        <div class="buttons">
         <form action="addclass10">
          <input  
          class="btn btn-outline-success btn-lg faizan" type="submit" value="Class-10"></form>
        </div>

        <div class="buttons">
         <form action="addclass11">
          <input 
          class="btn btn-outline-success btn-lg faizan" type="submit" value="Class-11"></form>
        </div>

        <div class="buttons">
         <form action="addclass12">
          <input  
          class="btn btn-outline-success btn-lg faizan" type="submit" value="Class-12"></form>
        </div>
      </div>
    </div>
  </div>
    ...
    <ul class="course-list">
      <div class="lists">
        <li class="btn btn-outline-success btn-lg">
          <i class="fas fa-book"></i> <a href="">Academic</a>
        </li>
      </div>
      <div class="lists">
        <li class="btn btn-outline-success btn-lg">
          <i class="fas fa-lightbulb"></i><a href="in-creativity.jsp">Creativity</a>
        </li>
      </div>
      <div class="lists">
        <li class="btn btn-outline-success btn-lg">
