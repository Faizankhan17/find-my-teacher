...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark  bg-dark sticky-top">
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
              <li><a class="dropdown-item" href="drawing-.html">Paper-Art</a></li>
              <li><a class="dropdown-item" href="classical.html">Classsical Dance</a></li>
              <li>
                <hr class="dropdown-divider">
              </li>
              <li><a class="dropdown-item" href="language.html">Language</a></li>
            </ul>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="inner-course.html">Teacher</a>
          </li>
          <li class="nav-item">
        ...
        <div>
          <i class="fas fa-user-plus" style="color: #fff; font-size: 1.3rem; margin-left: 1rem;"
            onclick="window.location.href='login.html'"></i>
        </div>
      </div>
    </div>
  </nav>
  ...
  <div class="card bg-dark text-white mt-0">
    <img src="images/result-img.jpg" class="card-img our-aim-img" alt="our Aim Image">
    <div class="card-img-overlay our-aim-text">
      <h1 class="card-title ouraim-title result-img-title">Let's Make a Better World Together</h1>
              ...
              <div class="col-xs-12 teacherlisting-about">
                ...
                <div class="top-93">
                  <div class="teacherlisting-about-text-right">
                    ...
                    <h6 class="rating">
                      <span class="hideprestar">⭐⭐⭐⭐⭐</span>0 reviews
                    </h6>
                    <h4>
                      <a href="" style="font-size: 15px; text-align: left;"><span><i
                            class="fab fa-telegram-plane"></i></span>
 ...
 -->
  ...
  <!-- <div class="container">
    <form action="" class="position-absolute top-100 start-100  form-position-left ">
     ...
     <input type="submit" class="btn btn-outline-success btn-lg" placeholder="Search" value="Search" style="width: 300px;">
    </form>
  </div> -->
