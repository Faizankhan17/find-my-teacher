  ...
  <ul class="dropdown-menu" style="background:none;">
    ...
    <div class=" products">
        ...
        <div class="  col-md-3 lg-3 col-xs-12  pt-3 pb-3 mt-2 mb-2 mr-3">
           ...
           <div class="image"> <img src="images/beginners.jpg" style="width: 170px; height: 150px; margin-left:25px;"></div>
        <form action="addBeginners">
            <input type="submit" placeholder="Dance For Biggener" value="Dance For Begnirrs" class="info btn btn-secondary mt-1" style="width:150px;"></form>
       
        </div>

        <div class="  col-md-3 lg-3 col-xs-12  pt-3 pb-3 mt-2 mb-2">
           
           <div class=""> <img src="images/salsa.jpg" style="width: 170px; height: 150px; margin-left:35px;"></div>
        <form action="addSalsa">
            <input type="submit" placeholder="Salsa" value="Salsa" class="info btn btn-secondary mt-1" style="width:150px;"></form>
        </div>

        <div class="  col-md-3 lg-3 col-xs-12  pt-3 pb-3 mt-2 mb-2">
            
           <div class=""> <img src="images/ballet.jpg" style="width: 170px; height: 150px; margin-left:40px;"></div>
        <form action="addBallet">
            <input type="submit" placeholder="Ballet" value="Ballet" class="info btn btn-secondary mt-1" style="width:150px;"></form>
        </div>

        <div class="  col-md-3 lg-3 col-xs-12  pt-3 pb-3 mt-2 mb-2 mr-3">
           
           <div class="image"> <img src="images/Hip-Hop.jpg" style="width: 170px; height: 150px;"></div>
       <form action="addHipHop">
            <input type="submit" placeholder="Hip-Hop" value="Hip-Hop" class="info btn btn-secondary mt-1"  style="width:150px;"></form>
        </label>
        </div>

        <div class="  col-md-3 lg-3 col-xs-12  pt-3 pb-3 mt-2 mb-2">
            
           <div class=""> <img src="images/Pop-Dancing1.jpg" style="width: 170px; height: 150px;"></div>
             <form action="addPopDance">
            <input type="submit" placeholder="Pop Dance" value="Pop Dance" class="info btn btn-secondary mt-1"  style="width:150px;"></form>
        </div>

        <div class="  col-md-3 lg-3 col-xs-12  pt-3 pb-3 mt-2 mb-2">
            
           <div class=""> <img src="images/contemporary.png" style="width: 170px; height: 150px;"></div>
         <form action="addContemporary">
            <input type="submit" placeholder="Contemporary" value="Contemporary" class="info btn btn-secondary mt-1" style="width:150px;"></form>
