  ...
  <ul class="dropdown-menu" style="background:none;">
    ...
    <div class=" products">
        ...
        <div class="  col-md-3 lg-3 col-xs-12  pt-3 pb-3 mt-2 mb-2 mr-3">
           ...
           <div class="image"> <img src="images/Kathak.png" style="width: 170px; height: 150px;"></div>
           <form action="addKathak">
            <input type="submit" placeholder="Kathak" value="Kathak" class="info btn btn-secondary mt-1" style="width:150px;"></form>
        </div>

        <div class="  col-md-3 lg-3 col-xs-12  pt-3 pb-3 mt-2 mb-2">
           
           <div class=""> <img src="images/bharatnatyam.png" style="width: 170px; height: 150px; margin-left:30px;"></div>
        <form action="addBharatnatyam">
            <input type="submit" placeholder="Bharatnatyam" value="Bharatnatyam" class="info btn btn-secondary mt-1" style="width:150px;"></form>
             
        </div>

        <div class="  col-md-3 lg-3 col-xs-12  pt-3 pb-3 mt-2 mb-2">
           <div class=""> <img src="images/odissi.jpg" style="width: 170px; height: 150px;"></div>
           <form action="addodissi">
            <input type="submit" placeholder="Odissi" value="Odissi" class="info btn btn-secondary mt-1" style="width:150px;"></form>
