  ...
  <ul class="dropdown-menu" style="background:none;">
    ...
    <div class=" products">
        ...
        <div class="  col-md-3 lg-3 col-xs-12  pt-3 pb-3 mt-2 mb-2 mr-3">
           ...
           <div class="image"> <img src="images/canvas-painting.png" style="width: 170px; height: 150px; margin-left:140px;"></div>
        <form action="addCanvas">
            <input type="submit" placeholder="Canvas painting" value="Canvas painting" class="info btn btn-secondary mt-2" style="margin-left:100px;"></form>
        ...
        <div class="  col-md-3 lg-3 col-xs-12  pt-3 pb-3 mt-2 mb-2">
           ...
           <div class=""> <img src="images/charcoal-painting.jpg" style="width: 170px; height: 150px; margin-left:110px;"></div>
       <form action="addCharcoal">
            <input type="submit" placeholder="Charcoal Painting " value="Charcoal Painting" class="info btn btn-secondary mt-2" style="margin-left:75px;"></form>
        
        </div>

        <div class="  col-md-3 lg-3 col-xs-12  pt-3 pb-3 mt-2 mb-2">
           
           <div class="sub"> <img src="images/glass-painting.png" style="margin-left:100px;"></div>
            <form action="addGlass">
            <input type="submit" placeholder="Glass Painting " value="Glass Painting" class="info btn btn-secondary mt-1" style="margin-left:70px;"></form>
        ...
        <div class="  col-md-3 lg-3 col-xs-12  pt-3 pb-3 mt-2 mb-2">
           ...
           <div class=""> <img src="images/Water-Color-painting.jpg" style="width: 170px; height: 150px; margin-left:40px;"></div>
        <form action="addWaterColour">
            <input type="submit" placeholder="Watercolor Painting " value="Watercolor Painting" class="info btn btn-secondary mt-1"></form>
        
       
        </div>
        <div class="  col-md-3 lg-3 col-xs-12  pt-3 pb-3 mt-2 mb-2">
          
         <div class=""> <img src="images/oil-painting.png" style="width: 170px; height: 150px; margin-left:38px;"></div>
     <form action="addOilPainting">
            <input type="submit" placeholder="Oil Painting " value="Oil Painting" class="info btn btn-secondary mt-1"></form>
