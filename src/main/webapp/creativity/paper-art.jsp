 ...
 <nav class="navbar navbar-expand-lg navbar-dark  bg-dark sticky-top">
  ...
  <div class=" products">
    ...
    <div class="  col-md-3 lg-3 col-xs-12  pt-3 pb-3 mt-2 mb-2 mr-3">
        ...
        <div class="image"> <img src="images/Origami.png" style="width: 170px; height: 150px; margin-left:30px;"></div>
        <form action="addOrigami">
            <input type="submit" placeholder="Origami" value="Origami" class="info btn btn-secondary  pl-2 pr-2"></form>
    </div>

    <div class="  col-md-3 lg-3 col-xs-12  pt-3 pb-3 mt-2 mb-2">
     
        <div class=""> <img src="images/Quiling.jpg" style="width: 170px; height: 150px;"></div>
          <form action="addQuiling">
            <input type="submit" placeholder="Origami" value="Quilling" class="info btn btn-secondary pl-2 pr-2"></form>
    </div>
