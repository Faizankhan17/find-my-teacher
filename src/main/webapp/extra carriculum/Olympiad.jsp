  ...
  <ul class="dropdown-menu" style="background:none;">
    ...
    <div class=" products">
        ...
        <div class="  col-md-3 lg-3 col-xs-12  pt-3 pb-3 mt-2 mb-2 mr-3">
           ...
           <div class="image"> <img src="images/olympiad-english.png" style="width: 170px; height: 150px; margin-left:40px;"></div>
            <form action="addEnglishOlympiad">
            <input type="submit" placeholder="English" value="English" class="info btn btn-secondary mt-3" style="width:150px;"></form>
      
        </div>

        <div class="  col-md-3 lg-3 col-xs-12  pt-3 pb-3 mt-2 mb-2">
            
           <div class=""> <img src="images/olympiad-maths.jpg" style="width: 170px; height: 150px; margin-left:50px;"></div>
              <form action="addMathsOlympiad">
            <input type="submit" placeholder="Maths" value="Maths" class="info btn btn-secondary mt-3" style="width:150px;"></form>
        </div>

        <div class="  col-md-3 lg-3 col-xs-12  pt-3 pb-3 mt-2 mb-2">
           
           <div class=""> <img src="images/olympiad-science.jpg" style="width: 170px; height: 150px; margin-left:50px;"></div>
              <form action="addScienceOlympiad">
            <input type="submit" placeholder="Science" value="Science" class="info btn btn-secondary mt-3" style="width:150px;"></form>
        </div>
