  ...
  <ul class="dropdown-menu" style="background:none;">
    ...
    <div class=" products">
        ...
        <div class="  col-md-3 lg-3 col-xs-12  pt-3 pb-3 mt-2 mb-2 mr-3">
           ...
           <div class="image"> <img src="images/c.jpg" style="width: 170px; height: 150px; margin-left:50px;"></div>
         <form action="addC">
            <input type="submit" placeholder="C" value="C" class="info btn btn-secondary" style="width:150px;"></form>
        </div>

        <div class="  col-md-3 lg-3 col-xs-12  pt-3 pb-3 mt-2 mb-2">
            
           <div class=""> <img src="images/cpp2.png" style="width: 170px; height: 150px; margin-left:50px;"></div>
         <form action="addCpp">
            <input type="submit" placeholder="C++" value="C++" class="info btn btn-secondary" style="width:150px;"></form>
    </div>
