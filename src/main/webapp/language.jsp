  ...
  <ul class="dropdown-menu" style="background:none;">
    ...
    <div class="container-fulid inner-feild-section mt-3 mt-2 pt-3 pb-3">
        ...
        <div class="inner-field ">
          <img src="images/language.png" class="rounded field-inner-img" alt="Extra carriculam img">
          <div class="field-heading">
  
            <h1 class="info">Choose Category</h1>
          </div>
        </div>
    </div>    
    ...
    <div class=" products">
        ...
        <div class="  col-md-3 lg-3 col-xs-12  pt-3 pb-3 mt-2 mb-2 mr-3">
           ...
           <div class="image"> <img src="images/englishh.jpg" style="width: 230px; height: 200px;"></div>
           <form action="addEnglishLanguage">
            <input type="submit" placeholder="English Language" value="EnglishLanguage" class="info btn btn-secondary mt-3" style="width:150px;"></form>
        </div>

        <div class="  col-md-3 lg-3 col-xs-12  pt-3 pb-3 mt-2 mb-2">
            
           <div class=""> <img src="images/franch.png" style="width: 230px; height: 200px;"></div>
       <form action="addFrenchLanguage">
            <input type="submit" placeholder="French" value="French" class="info btn btn-secondary mt-3" style="width:150px;"></form>
        </div>
